...
This project is an **AI-enhanced email automation workflow** built with [n8n](https://n8n.io/). It listens for incoming emails via Gmail, classifies them, and—if it's a support query—responds using an AI Agent powered by **OpenAI** and **Pinecone Vector Store**.
...
![Workflow Screenshot](./your-screenshot.png) <!-- Replace with your actual image path -->
